...
import { Send, CheckCircle, Shield, Landmark, Heart } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen pt-40 pb-20 flex flex-col items-center justify-center px-4 text-center aurora-bg">
        ...
        <p className="text-lg md:text-2xl text-slate-400 max-w-2xl mx-auto mb-16 leading-relaxed font-medium">
          Your credentials have been uploaded to our secure ingestion portal. Our vetting team typically responds within 24-48 business hours.
        </p>
        <button 
      ...
      <section ref={ref} className="py-24 md:py-32 overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className={`mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <h1 className="text-5xl md:text-8xl font-black mb-10 tracking-tighter text-white uppercase text-glow leading-[0.9]">Secure Enrollment.</h1>
            <p className="text-xl md:text-2xl text-slate-400 mb-12 md:mb-16 leading-relaxed font-medium">
              Join the Alliance. Select your role to initiate the ingestion protocol.
            </p>
          </div>
